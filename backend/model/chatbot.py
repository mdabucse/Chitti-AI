...
def resume_chat_session(chat_name):
    ...
    session_data = chat_collection.find_one({"chat_name": chat_name})
    return session_data["chat_pairs"] if session_data and "chat_pairs" in session_data else []

def main(chat_name,user_message,end_session):
